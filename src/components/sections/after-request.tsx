import { Clock, Car, Video, FileText } from "lucide-react";
...
const stepIcons: LucideIcon[] = [Clock, Car, Video, FileText];
                ...
                <div className={`flex items-center gap-10 py-8 ${i > 0 ? "border-t border-[#e4e8ec]" : ""}`}>
                  ...
                  {isVideo ? (
                    <div className="relative w-[200px] h-[130px] rounded-2xl overflow-hidden shrink-0">
                      <Image
                        src="/images/video-call-new.png"
                        alt="Видеозвонок с врачом"
                        fill
